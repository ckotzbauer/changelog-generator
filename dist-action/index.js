...
const commander_1 = __webpack_require__(444);
const path_1 = __webpack_require__(622);
const generator_1 = __webpack_require__(96);
const program = new commander_1.Command();
program.version(require((0, path_1.resolve)(`${__dirname}/../package.json`)).version);
...
if (!program.opts().releaseVersion) {
    program.opts().releaseVersion = require((0, path_1.resolve)(`${program.opts().repository}/package.json`)).version;
}
(0, generator_1.generate)(program.opts());
...
const { Argument } = __webpack_require__(991);
const { Command } = __webpack_require__(916);
const { CommanderError, InvalidArgumentError } = __webpack_require__(913);
const { Help } = __webpack_require__(728);
const { Option } = __webpack_require__(592);
...
const git_plugin_error_1 = __webpack_require__(745);
...
const { InvalidArgumentError } = __webpack_require__(913);
...
const { humanReadableArgName } = __webpack_require__(991);
...
const { Argument, humanReadableArgName } = __webpack_require__(991);
const { CommanderError } = __webpack_require__(913);
const { Help } = __webpack_require__(728);
const { Option, splitOptionFlags } = __webpack_require__(592);
const { suggestSimilar } = __webpack_require__(375);
